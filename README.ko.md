...
> **🔬 실험적 도구 안내**
> 
> 이 프로젝트는 타사 서비스(Google Gemini 및 ChatGPT)의 브라우저 자동화에 의존하는 **실험적인 도구**입니다. 다음 사항을 유의해 주세요:
> 
> - **UI 변경으로 인한 기능 중단 가능성**: 이 도구는 언제든지 변경될 수 있는 웹 인터페이스와 상호작용합니다. Google이나 OpenAI가 CSS 클래스명, HTML 구조 또는 페이지 레이아웃을 조금만 업데이트해도 스크립트가 예고 없이 작동을 멈출 수 있습니다.
> - **학습 목적**: 이 도구는 **학습 및 실험 목적**으로만 제공됩니다.
> - **서비스 이용 약관 준수**: 사용자는 이 도구의 사용이 Google Gemini, ChatGPT 및 기타 관련 서비스의 이용 약관을 준수하는지 확인할 **전적인 책임**이 있습니다.
> - **보증 없음**: 이 소프트웨어는 MIT 라이센스에 따라 "있는 그대로" 제공됩니다. 작성자 및 기여자는 사용으로 인해 발생하는 어떠한 문제에 대해서도 책임을 지지 않습니다.
> 
> 이 도구를 사용함으로써 귀하는 이러한 제한 사항과 책임을 인정하고 수락하는 것으로 간주됩니다.
